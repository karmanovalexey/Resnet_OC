...
class _SelfAttentionBlock(nn.Module):
    ...
    '''
    def __init__(self, in_channels, key_channels, value_channels, out_channels=None, scale=1, modified_context=False):
...
class BaseOC_Module(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, key_channels, value_channels, dropout, sizes=([1]), modified_context=False):

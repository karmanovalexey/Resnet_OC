...
def get_resnet34_base_oc_layer3(num_classes=66, pretrained_backbone=False, modified_context=False):
    ...
    model = ResNet_Base_OC(backbone, inplanes, outplanes, num_classes, modified_context)
    
    return model


class ResNet_Base_OC(nn.Module):
    def __init__(self, backbone, inplanes, outplanes, num_classes, modified_context=False):
